			...
			*/
			...
			switch($module) 
			{
				...
				case "survey":
						...
						$panelId = str_replace( " " , "" , strtolower($module.$postData[eventModId]) ) ;
						$editLink = " | <a href='javascript:;' title='Edit Module' onclick=\"editModule('survey',".$postData[eventModId].")\"><b>Edit</b></a> " ;
						$boxId = $module."_".$postData[eventModId] ;
						...
						///// event survey
						$this->tbl_event_module_survey_master() ;
						$condition = " event_id = '".$postData[eventId]."' AND event_module_id = '".$postData[eventModId]."' " ;
						$result = $this->selectRecord( $condition ) ;
						$recordCount = $this->recordNumber( $result ) ;
						...
						if( $recordCount > 0 )
						{
							$surveyList = $this->fetchRecord( $result ) ;

							$survey = "<table width=100% cellpadding=2 cellspacing=2 border=0>" ;
							$questionCnt = 1 ;
							foreach( $surveyList as $surveyKey=>$surveyValue )
							{
								$surveyId = $surveyValue["survey_id"] ;
								
								$deleteLink = "<div style='float:right'><a href=\"javascript:editModuleSurvey('survey',".$postData[eventModId].");\" title='Edit Servey Question'> <img class='photosmall' src='../images/edit.gif'> </a>&nbsp;<a title='Remove Servey Question' href=\"javascript:removeModuleElement('survey','".$surveyId."');\"><img class='photosmall' src='../images/delete.png'></a></div>" ;
								
								$survey .= "<tr>" ;
								$survey .= "<td colspan=2 align=left>".$deleteLink."<b>".$questionCnt.". &nbsp; ".ucfirst($surveyValue["survey_question"])."</b></td>" ;
								$survey .= "</tr>" ;
								$survey .= "<tr>" ;
								$survey .= "<td width=5% align=right><input type='radio' name='".$surveyId."_q_ans[]' value='".$surveyId."_"."1' id='".$surveyId."_"."1'>" ;
								$survey .= "<td width=95% align=left><label for='".$surveyId."_"."1'>".$surveyValue["survey_ans_1"]."</label></td>" ;
								$survey .= "</tr>" ;
								
								$survey .= "<tr>" ;
								$survey .= "<td width=5% align=right><input type='radio' name='".$surveyId."_q_ans[]' value='".$surveyId."_"."2' id='".$surveyId."_"."2'>" ;
								$survey .= "<td width=95% align=left><label for='".$surveyId."_"."2'>".$surveyValue["survey_ans_2"]."</label></td>" ;
								$survey .= "</tr>" ;

								$survey .= "<tr>" ;
								$survey .= "<td width=5% align=right><input type='radio' name='".$surveyId."_q_ans[]' value='".$surveyId."_"."3' id='".$surveyId."_"."3'>" ;
								$survey .= "<td width=95% align=left><label for='".$surveyId."_"."3'>".$surveyValue["survey_ans_3"]."</label></td>" ;
								$survey .= "</tr>" ;
							...
							$survey = "<div style='text-align:left;'>Click on edit to manage survey.</div>" ;
						///// end event survey

						$addModule = str_replace( "[BOX_TITLE]" , "Survey" , $moduleC ) ;
						$addModule = str_replace( "[BOX_ID]" , $boxId , $addModule ) ;
						$addModule = str_replace( "[EDIT_MODULE]" , $editLink , $addModule ) ;
						$addModule = str_replace( "[IMG_ARROW]" , $imgArrow , $addModule ) ;
						$addModule = str_replace( "[REMOVE_MODULE]" , $removeModule , $addModule ) ;
						...
						$addModule = str_replace( "[MODULE_CLASS]" , "bigArticle" , $addModule ) ;
						$addModule = str_replace( "[TABLE_WIDTH]" , $txteventmoduleboxwidth , $addModule ) ;
						$addModule = str_replace( "[BOX_CONTENT]" , $survey , $addModule ) ;
