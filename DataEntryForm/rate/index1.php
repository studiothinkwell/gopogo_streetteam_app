...
<script language="Javascript" type="text/javascript">
   ...
   // google.setOnLoadCallback(OnLoad);
	...
	function OnSearchComplete(result)
	{
		...
		count = -1;
		//console.log(("#searchcontrol").find("(0)"));
		...
		// document.write("<style type='text/css'>.gsc-twiddle div{display:none;}</style>") ;
		 ...
		 //searchcontrol.inner.document.getElementById('bn').style.disabled = true; 
		 // 
...
<form action="someplace.html" method="post" name="myForm">
  ...
  <div id="navigation">
	<ul>
		<li><a href="http://www.dev.thinkwellgroup.com/rate"><span class="tab">Review a place</span></a></li>
		<li><a href="http://www.dev.thinkwellgroup.com/playlist"><span class="tab2">Create a playlist</span></a></li>
	</ul>
</div>
    ...
    <div class="ss-item ss-item-required ss-checkbox">
      <div class="ss-form-entry">
        ...
        <ul class="ss-choices">
          ...
          <li class="ss-choice-item">
            <label class="ss-choice-label">
              <input name="txtrange[]" value="Kid Friendly" class="ss-q-checkbox" id="group_10_2" type="checkbox">
              Kid Friendly</label>
          </li>
          <li class="ss-choice-item">
            <label class="ss-choice-label">
              <input name="txtrange[]" value="21 &amp; Over" class="ss-q-checkbox" id="group_10_3" type="checkbox">
              21 &amp; Over</label>
          </li>
          <li class="ss-choice-item">
            <label class="ss-choice-label">
              <input name="txtrange[]" value="Golden Years" class="ss-q-checkbox" id="group_10_4" type="checkbox">
              Golden Years</label>
          </li>
        </ul>
      </div>
...
Anyime</label>
          ...
          <li class="ss-choice-item">
            <label class="ss-choice-label">
              <input name="txtbtg[]" value="Morning" class="ss-q-checkbox" id="group_10_2" type="checkbox">
              Morning</label>
          </li>
          <li class="ss-choice-item">
            <label class="ss-choice-label">
              <input name="txtbtg[]" value="Day" class="ss-q-checkbox" id="group_10_3" type="checkbox">
              Day</label>
          </li>
          <li class="ss-choice-item">
            <label class="ss-choice-label">
              <input name="txtbtg[]" value="Night" class="ss-q-checkbox" id="group_10_4" type="checkbox">
              Night</label>
          </li>
        </ul>
      </div>
