...
DHTMLSuite.form.prototype = 
{
	...
	submit : function()
	{
		if( document.getElementById('entry_4').value == "" )
			{
				alert("Please enter the playlist name before submitting ") ;
		...
		{
			alert("Please enter the required information before submitting 3") ;
		...
		{
			alert("Please select the required information before submitting - Best time to go! ") ;
		...
		if( !isNaN(document.getElementById('txthmt').value) == "" )
		{
		...
		if( !isNaN(document.getElementById('entry_7').value) == "" )
		{
			alert("Please enter numeric value") ;
			document.getElementById('entry_7').focus() ;
			return false ;
