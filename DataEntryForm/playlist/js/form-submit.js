...
DHTMLSuite.form.prototype = 
{
	...
	submit : function()
	{
		...
		if(document.getElementById('entry_4').value == "") 
		{
			alert("Please enter proper information before submitting") ;	
			document.getElementById('entry_4').focus() ;
			return false ;
		}
		
		var retValue = document.getElementById('entry_4').value ;
		var ch = retValue.substring(0, 1);
		if(ch == " ") 
		{
			alert("Please enter valid information before submitting") ;	
			document.getElementById('entry_4').value = "" ;
			document.getElementById('entry_4').focus() ;
			return false ;
		}
		...
		while(ch1 == " ")
		{
			...
			document.getElementById('entry_4').value = retValue ;
		}
		...
		//var retValue6 = document.getElementById('entry_6').value ;
		if( !retValue.match(alphaExp) )
		{
			alert("Please enter valid information before submitting aa") ;	
			document.getElementById('entry_6').focus() ;
			return false ;
		}
		*/
		var retValue2 = document.getElementById('entry_6').value ;
		var chn = retValue2.substring(0, 1);
		if(chn == " ") 
		{
		...
		var chn1 = retValue2.substring( ( parseInt(retValue2.length)-1 ) , parseInt(retValue2.length) );
		while(chn1 == " ")
		{
			retValue2 = retValue2.substring(0, retValue2.length-1);
      		chn1 = retValue2.substring(retValue2.length-1, retValue2.length);
			document.getElementById('entry_6').value = retValue2 ;
		}
		...
		{
			alert("Please select , Crowd Type.");
			return false;
		}
		/**********************/
		...
		{
			alert("Please select an option from Good for?");
			return false;
		}
		/**********************/
		...
		{
			alert("Please select an option from Best When?");
			return false;
		}
		/*************************************/
		...
		if (hasChecked2 == false)
		{
			alert("Please select an option from, Best time to go?");
			return false;
		}
		/**********************/
		...
		var chks2 = document.getElementsByName('txttbs[]');
		var hasChecked2 = false;
		for (var i = 0; i < chks2.length; i++)
		{
			if (chks2[i].checked)
		...
		if (hasChecked2 == false)
		{
			alert("Please select Transportation between stops?");
			return false;
		}
		/**********************/
