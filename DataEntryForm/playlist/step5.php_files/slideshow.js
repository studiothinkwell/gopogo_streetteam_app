...
//manual stop
	...
	this.b_insert= function(){
		...
		var myhtml="<div style='width:"+picwid+"px;height:"+slidehei+"px; text-align:left;'>";
   			myhtml+="<div style='position:absolute;width:"+picwid+"px;height:"+pichei+"px;background-color:gray;'>";
		for(b=1;b<=emax;b++){
			thez=1;thevis='hidden';
			if(b<=1) {thez=2; thevis='visible';}
			  var t2 = imges[(b-1)].split("#") ;
			  myhtml+="<div id='img_"+slideid+"_"+b+"' style='font-size:0;line-height:"+pichei+"px;margin:0;padding:0;text-align:center;visibility:"+thevis+";z-index:"+thez+";position:absolute;left:0;top:0;width:"+picwid+"px;height:"+pichei+"px;background-color:"+backgr+";'>";
				myhtml+="<center><img src='"+t2[0]+"' width="+t2[1]+" height="+t2[2]+" style='vertical-align:middle;border:0;padding-right:10px;' alt=''/></center></div>";
				//myhtml+="<center><img src='"+t2[0]+"' width='300' height='300' style='vertical-align:middle;border:0;padding-right:10px;' alt=''/></center></div>";
		}
   			myhtml+="</div>";
//show controls
		if(showcontr){
